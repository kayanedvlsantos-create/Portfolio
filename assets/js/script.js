...
async function getAboutGithub() {
  try {
    const resposta = await fetch(
      "https://api.github.com/users/kayanedvlsantos-create",
    );
    ...
    about.innerHTML = `
            ...
            <div class="about-buttons-data">
                <div class="buttons-container">
                    ...
                    <a href="https://drive.google.com/file/d/1Ey8RUvTgPNh028g7r0Ru6iWh0afm-FlE/view?usp=sharing" target="_blank" class="botao-outline">Currículo</a>
                </div>
...
async function getProjectsGithub() {
  try {
    ...
    const resposta = await fetch('https://api.github.com/users/kayanedvlsantos-create/repos?sort=updated&per_page=6');
